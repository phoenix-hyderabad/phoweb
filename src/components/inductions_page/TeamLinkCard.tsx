  ...
  (
    ...
    return open ? (
      <Link
        ref={ref}
        className={cn(
          "before:border-glow bg-card relative flex w-full flex-col gap-4 rounded-2xl px-2 py-4 before:absolute before:-bottom-[1px] before:-left-[1px] before:-right-[1px] before:-top-[1px] before:-z-10 before:rounded-2xl before:content-[''] max-lg:justify-between max-sm:flex-col",
          className,
        )}
      ...
      <div className="bg-card relative flex w-full flex-col gap-4 rounded-2xl px-2 py-4 brightness-75">
        {inner}
      </div>
    );
  },
...
export const TeamLinkCardSkeleton = () => {
  return (
    <div className="bg-card relative flex w-full flex-col items-center gap-4 rounded-2xl px-2 py-4 brightness-75">
